...
namespace fuzzer {
  ...
  static s8 INTERESTING_8[] = { 0, 1, 8, 2, 4, 3, 5, 127};
  // static s16 INTERESTING_16[] = {-128, -1, 0, 1, 16, 32, 64, 100, 127, -32768, -129, 128, 255, 256, 512, 1000, 1024, 4096, 32767};
  static s16 INTERESTING_16[] = { 0, 1, 8, 2, 4, 3, 5, 255, 32767, 9, 6, 16, 32, 64, 128, 17};
  ...
  static s32 INTERESTING_32[] = { 0, 1, 8, 2, 4, 3, 5, 255, 9, 6, 16, 32, 64, 128, 65535, 4096, 8192, 16384, 32768, 2147483647};
